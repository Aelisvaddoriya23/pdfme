...
const generate = async (props) => {
    ...
    for (let i = 0; i < inputs.length; i += 1) {
        ...
        for (let j = 0; j < basePages.length; j += 1) {
            ...
            fs.writeFileSync(`/Users/icanstudiozmac1/Documents/whatsapp-api/whatsapp-api/assets/baseDemo2.pdf`, pdfDoc.saveAsBase64());
    ...
    fs.writeFileSync(`/Users/icanstudiozmac1/Documents/whatsapp-api/whatsapp-api/assets/baseDemo3.txt`, pdfDoc.saveAsBase64());
